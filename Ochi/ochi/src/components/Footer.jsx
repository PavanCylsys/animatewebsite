...
function Footer() {
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 font-["Founders_Grotesk_X-Condensed "]'>
        <div className='w-1/2 h-full flex flex-col justify-between   '>
          <div className='heading'>
            <h1 className='text-[7vw] font-semibold uppercase leading-none '>Eye</h1>
        ...
        <div className=''>
        <h1 className='text-[7vw] font-semibold uppercase leading-none '>Presentetions</h1>
